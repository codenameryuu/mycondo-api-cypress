...
describe("Spec: validate request access token with invalid data", () => {
  it("Should be failed, case: token is required", () => {
    cy.request({
      method: "POST",
      url: apiUrl + "/validate-request-access-token",
      body: {
        token: null,
        language: "en",
      },
...
// describe("Spec: validate request access token with valid data", () => {
//   it("Should be success, case: all data is valid", () => {
//     cy.request({
//       method: "POST",
//       url: apiUrl + "/request-access/validate-request-access-token",
//       body: {
//         token: token,
//         language: "en",
//       },
